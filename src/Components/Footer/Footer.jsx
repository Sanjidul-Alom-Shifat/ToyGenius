...
import logo from '../../assets/attachment_80402256.png'
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center text-black sm:justify-start">
                            ...
                            <h2 className='text-xl font-bold tracking-wide ml-3 text-gray-800 hover:text-amber-400 hover:cursor-pointer'>ToyGenius</h2>
                        ...
                        >
                            At ToyGenius, we believe in the power of play to shape young minds. Discover a world of endless fun and discovery with our curated collection of innovative toys, designed to ignite curiosity and spark joy in every child.
                        </p>
